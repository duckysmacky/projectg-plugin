...
public class ItemCatalog {
    ...
    private static String[][] kitCatalog = {
            ...
            {"Cryo Kit", "assault", "cryo", "complex", "&fProvides an ability to freeze areas and slowing down the opponents, while having good area control", "PACKED_ICE"},
            {"Recon Kit", "assault", "recon", "professional", "&fUtility helps locate enemies and initiate a fight with them", "COMPASS"},
            {"Spy Kit", "assault", "spy", "professional", "&fProvides utility for flanking and stealth attacks", "STRING"},
            ...
            {"Blade Kit", "skirmisher", "blade", "elite", "&c&lYOU CAN ONLY USE A SECONDARY WEAPON WITH THIS KIT!\n&fYou get a powerful blade and increased mobility\nto close down on the range", "DIAMOND_SWORD"},
            ...
            {"Chainsaw Kit", "assassin", "chainsaw", "professional", "&fKit provides chainsaw(s)... brrrr", "NETHER_STAR"},
            {"Biohazard Kit", "assassin", "biohazard", "professional", "&fKit provides a biogun and some chemical utility", "SEEDS"},
            {"Nuclear Kit", "assassin", "nuclear", "elite", "&fThe name speaks for itself", "TNT"},
            ...
            {"Artillery Kit", "sentinel", "artillery", "complex", "&fProvides a placeable artillery cannon which can be shot with powerful rounds", "SPECTRAL_ARROW"},
    ...
    private static String[][] gunCatalog = {
            ...
            {"Origin-12", "shotgun", "MW_ORIGIN12", "MW_ORIGIN12MAG", "12", "rare"},
            ...
            {"Nether Blaster", "special", "TECHGUNS_NETHERBLASTER", "8843:76", "12", "legendary"},
